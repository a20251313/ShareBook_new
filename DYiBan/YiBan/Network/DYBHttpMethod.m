...
+ (MagicRequest *)shareBook_security_login_username:(NSString *)username password:(NSString *)password sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_security_login_username:username password:password];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_security_reg_username:(NSString *)username password:(NSString *)password phone_num:(NSString *)phone_num nickName:(NSString *)nick sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_security_reg_username:username password:password phone_num:phone_num nickName:nick];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_book_upload_book_id:(NSString *)book_id lent_way:(NSString *)lent_way deposit_type:(NSString *)deposit_type deposit:(NSString *)deposit loan_period:(NSString *)loan_period public:(NSString *)_public remark:(NSString *)remark lat:(NSString *)lat lng:(NSString *)lng sskey:(NSString *)sskey address:(NSString *)address circle_id:(NSString *)circle_id sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_book_upload_book_id:book_id lent_way:lent_way deposit_type:deposit_type deposit:deposit loan_period:loan_period public:_public remark:remark lat:lat lng:lng sskey:sskey address:address circle_id:circle_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_book_reserve_pub_id:(NSString *)pub_id content:(NSString *)content sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_book_reserve_pub_id:pub_id content:content];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_book_commentlist_pub_id:(NSString *)pub_id page:(NSString *)page num:(NSString *)num sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_book_commentlist_pub_id:pub_id page:page num:num];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_user_detail_user_id:(NSString *)user_id sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_user_detail_user_id:user_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_circle_add_circle_name:(NSString *)circle_name
                                           address:(NSString *)address lat:(NSString *)lat
                                               lng:(NSString *)lng
                                              kind:(NSString *)kind sAlert:(BOOL)isAlert receive:(id)receive{
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_circle_add_circle_name:circle_name  address:address lat:lat lng:lng kind:kind];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_user_friendlist_user_id:(NSString *)user_id sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_user_friendlist_user_id:user_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_address_list_user_id:(NSString *)user_id
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_address_list_user_id:user_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
}
...
+ (MagicRequest *)shareBook_circle_detail_circle_id:(NSString *)circle_id sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_circle_detail_circle_id:circle_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
}
...
+ (MagicRequest *)shareBook_user_booklist_user_id:(NSString *)user_id page:(NSString *)page num:(NSString *)num sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_user_booklist_user_id:user_id page:page num:num];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+ (MagicRequest *)shareBook_circle_booklist_user_id:(NSString *)user_id page:(NSString *)page num:(NSString *)num sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface shareBook_circle_booklist_user_id:user_id page:page num:num];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;

}
+ (MagicRequest *)book_loan_order_id:(NSString *)order_id content:(NSString *)content loan_time:(NSString *)loan_time address:(NSString *)address sAlert:(BOOL)isAlert receive:(id)receive{

    NSMutableDictionary *dict = [DYBHttpInterface book_loan_order_id:order_id content:content loan_time:loan_time address:address];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
}
...
+(MagicRequest *)message_send_userid:(NSString *)userid content:(NSString *)content type:(NSString *)type mid:(NSString *)mid orderid:(NSString *)orderid sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface message_send_userid:userid content:content type:type mid:mid orderid:(NSString *)orderid];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
...
+(MagicRequest *)book_order_pub_id:(NSString *)pub_id sAlert:(BOOL)isAlert receive:(id)receive{
    ...
    NSMutableDictionary *dict = [DYBHttpInterface book_order_pub_id:pub_id];
    DYBRequest *request = AUTORELEASE([[DYBRequest alloc] init]);
    MagicRequest *dre = [request DYBGET:dict isAlert:isAlert receive:receive];
    return dre;
